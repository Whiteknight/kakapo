...
our method test_assert_block_pass() {
...
our method test_assert_block_fail() {
...
our method test_assert_not_same() {
	my $s := "Hello, world.";
	my $t := "Hello, world.";
...
our method test_assert_not_same_fails() {
	my $s := "Hello, world.";
	my $t := $s;
...
our method test_assert_throws_wrong_type() {
...
our method test_assert_throws_exception() {
...
our method test_assert_throws_doesnt_throw() {
